...
ARGUMENTS_=["LastVideoBV", "OiMode", "MultiThread", "Content", "DownloadDir" , "LastSuccess"]
DEFAULT_ARGUMENTS__={"LastVideoBV":"BV0", "OiMode":False, "MultiThread":False, "Content": "Video", "DownloadDir":r".\Downloads\ " , "LastSuccess": True}
...
def DownloadArgsSelector(Oi):
    def ArgsGetter():
        ...
        return [CONTENT,MULTITHREAD,DOWNLOADDIR]
